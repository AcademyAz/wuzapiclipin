...
func (s *server) routes() {
	...
	s.router.Handle("/chat/send/request-payment", c.Then(s.SendRequestPayment())).Methods("POST")
	s.router.Handle("/send/request-payment", c.Then(s.SendRequestPayment())).Methods("POST")
